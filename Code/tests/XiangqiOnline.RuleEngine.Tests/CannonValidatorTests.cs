...
public class CannonValidatorTests
{
    ...
    [Fact]
    public void Cannon_MoveNoEatingWithMount_Fail()
    {
    ...
    [Fact]
    public void Cannon_EatWithExact1Mount_Success()
    {
        var board = BoardState.CreateInitialBoard();
        var b = board.Pieces.ToBuilder();
    ...
    [Fact]
    public void Cannon_EatWith0Mounts_Fail()
    {
        var board = BoardState.CreateInitialBoard();
        var b = board.Pieces.ToBuilder();
    ...
    [Fact]
    public void Cannon_EatWith2Mounts_Fail()
    {
        var board = BoardState.CreateInitialBoard();
        var b = board.Pieces.ToBuilder();
    ...
    [Fact]
    public void Cannon_EatFriendlyPieceWith1Mount_Fail()
    {
        var board = BoardState.CreateInitialBoard();
        var b = board.Pieces.ToBuilder();
    ...
    [Fact]
    public void Cannon_HorizontalEatWith1Mount_Success()
    {
    ...
    [Fact]
    public void Cannon_EatEnemyChariotWith1Mount_Success()
    {
        var board = BoardState.CreateInitialBoard();
        var b = board.Pieces.ToBuilder();
    ...
    [Fact]
    public void Cannon_BackwardMoveNoMount_Success()
    {
    ...
    [Fact]
    public void Cannon_OverRiverMove_Success()
    {
    ...
    [Fact]
    public void BlackCannon_EatRedPawn_Success()
    {
