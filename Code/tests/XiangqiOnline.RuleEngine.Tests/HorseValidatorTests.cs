...
public class HorseValidatorTests
{
    ...
    [Fact]
    public void RedHorse_FootBlockedUp_Fail()
    {
    ...
    [Fact]
    public void RedHorse_FootBlockedRight_Fail()
    {
    ...
    [Fact]
    public void RedHorse_LandOnFriendlyPiece_Fail()
    {
