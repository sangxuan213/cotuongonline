...
public class MoveValidationPipelineTests
{
    ...
    public void Pipeline_ValidMove_ShouldReturnSuccess()
    {
        ...
        var intent = new MoveIntent("move-1", new Position(0, 6), new Position(0, 5), 0L);
    ...
    public void Pipeline_WrongTurn_ShouldReturnNotYourTurnError()
    {
        ...
        var intent = new MoveIntent("move-2", new Position(0, 6), new Position(0, 5), 0L);
    ...
    public void Pipeline_InvalidCoordinate_ShouldReturnInvalidCoordinateError()
    {
        ...
        var intent = new MoveIntent("move-3", new Position(-1, 0), new Position(0, 5), 0L);
    ...
    {
        var board = BoardState.CreateInitialBoard();
        var intent = new MoveIntent("move-4", new Position(0, 6), new Position(0, 6), 0L);
    ...
    {
        var board = BoardState.CreateInitialBoard();
        var intent = new MoveIntent("move-5", new Position(0, 5), new Position(0, 4), 0L);
    ...
    public void Pipeline_NotYourPieceWhenCorrectTurn_ShouldReturnNotYourTurnError()
    {
        ...
        var intent = new MoveIntent("move-6", new Position(0, 3), new Position(0, 4), 0L);
    ...
    {
        var board = BoardState.CreateInitialBoard();
        var intent = new MoveIntent("move-7", new Position(0, 9), new Position(0, 6), 0L); // Red Chariot moving to friendly Pawn at (0,6)
    ...
    {
        var board = BoardState.CreateInitialBoard();
        var intent = new MoveIntent("move-8", new Position(0, 9), new Position(0, 5), 0L); // Red Chariot over (0,6) Pawn
    ...
    public void Pipeline_HorseLegBlocked_ShouldReturnHorseLegBlockedError()
    {
        ...
        var intent = new MoveIntent("move-9", new Position(1, 9), new Position(2, 7), 0L);
